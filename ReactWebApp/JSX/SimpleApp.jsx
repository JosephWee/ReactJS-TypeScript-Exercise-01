...
(function (SimpleApp) {
    ...
    App.propTypes = {
        TeleportAPI: PropTypes.instanceOf(JSHelpers.TeleportAPIHelper1)
    };
    SimpleApp.App = App;
})(SimpleApp || (SimpleApp = {}));
...
ReactDOM.render(React.createElement(SimpleApp.App, { TeleportAPI: new JSHelpers.TeleportAPIHelper() }), document.getElementById('root'));
